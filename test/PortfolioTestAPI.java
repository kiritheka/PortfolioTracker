...
class PortfolioTestAPI {
	...
	void testGetStockPrice() {
		...
		stockPriceAndCount.put(57.47,100.0);
		stockPriceAndCount.put(1097.71,50.0);
		...
		assertEquals("{57.47=100.0, 1097.71=50.0}".toString(), portfolioImpl.getStockPrice(expectedResult).toString());

		 //assertEquals(stockPriceAndCount.toString(),portfolioImpl.getStockPrice(expectedResult).toString());
